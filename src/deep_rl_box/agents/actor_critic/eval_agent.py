...
from deep_rl_box.networks.policy import ActorCriticMlpNet, ActorCriticConvNet
...
environment_name = "CartPole-v1"  # Both Classic control tasks (e.g., CartPole-v1, LunarLander-v2, MountainCar-v0, Acrobot-v1) and Atari games (e.g., Pong, Breakout).
...
load_checkpoint_file = "./checkpoints/actor-critic"  # Load a specific checkpoint file.
...
def main():
    ...
    # Test network output and build it.
    ...
    checkpoint = TensorFlowCheckpoint(environment_name=environment_name, agent_name='Actor-Critic', restore_only=True)
