...
From the paper "Dueling Network Architectures for Deep Reinforcement Learning"
...
from deep_rl_box.networks.common import disable_trainability


class DuelingDqn(types_lib.Agent):
    """Dueling DQN agent"""
    ...
    def __init__(
        ...
        self._target_network = tf.keras.models.clone_model(self._online_network)
