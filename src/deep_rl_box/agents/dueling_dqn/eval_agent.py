"""Tests trained Dueling DQN agent from checkpoint with a e-greedy actor.
...
from deep_rl_box.networks.value import DuelingDqnMlpNet, DuelingDqnConvNet
...
flags.DEFINE_string('load_checkpoint_file', './checkpoints/dueling-dqn', 'Load a specific checkpoint file.')
flags.DEFINE_string(
    'recording_video_dir',
    'recordings',
...
def main(argv):
    ...
    checkpoint = TensorFlowCheckpoint(environment_name=FLAGS.environment_name, agent_name='Dueling-DQN', restore_only=True)
