...
from deep_rl_box.networks.value import DqnMlpNet, DqnConvNet
...
flags.DEFINE_string('load_checkpoint_file', './checkpoints/double-dqn', 'Load a specific checkpoint file.')
flags.DEFINE_string(
    'recording_video_dir',
    'recordings',
...
def main(argv):
    ...
    checkpoint = TensorFlowCheckpoint(environment_name=FLAGS.environment_name, agent_name='Double-Q', restore_only=True)
