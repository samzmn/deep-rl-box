...
class QRDqn(types_lib.Agent):
    ...
    def __init__(
        ...
        base.assert_rank_and_dtype(quantiles, 1, tf.float32)
        ...
        self._num_taus = quantiles.shape[0]
    ...
    def _calc_loss(self, transitions: replay_lib.Transition) -> Tuple[tf.Tensor, np.ndarray]:
        ...
        tau_tm1 = tf.broadcast_to(tf.reshape(self._quantiles, (1, -1)), [dist_q_tm1.shape[0], dist_q_tm1.shape[1]])  # [batch_size, num_taus]
        ...
        priorities = loss.numpy()  # [batch_size]
