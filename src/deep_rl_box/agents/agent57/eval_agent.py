...
from deep_rl_box.networks.value import Agent57Conv2dNet
from deep_rl_box.networks.curiosity import RndConvNet, NguEmbeddingConvNet
...
def main(argv):
    ...
    checkpoint = TensorFlowCheckpoint(environment_name=FLAGS.environment_name, agent_name='Agent57', restore_only=True)
    ...
    rnd_target_network.trainable = False
    rnd_predictor_network.trainable = False
