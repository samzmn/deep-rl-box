...
from deep_rl_box.networks.value import Agent57Conv2dNet, Agent57NetworkInputs
...
def main(argv):
    ...
    optimizer = tf.optimizers.Adam(lr=FLAGS.learning_rate, eps=FLAGS.adam_eps)
    ...
    intrinsic_optimizer = tf.optimizers.Adam(lr=FLAGS.int_learning_rate, eps=FLAGS.adam_eps)
