...
from deep_rl_box.utils.main_loop import run_parallel_training_iterations, run_learner
...
cluster_distance = 0.008 # K-nearest neighbors custer distance.
max_similarity = 8.0 # K-nearest neighbors custer distance.
...
target_net_update_interval =1500 # The interval (meassured in Q network updates) to update target Q networks.
...
def main():
    ...
    actors = [
        agent.Actor(
            ...
            random_state=np.random.RandomState(seed + int(i)),
