...
from deep_rl_box.agents.prioritized_dqn import agent
...
flags.DEFINE_string('checkpoint_dir', './checkpoints/prioritized-dqn', 'Path for checkpoint directory.')


def main(argv):
    """Trains DQN agent with prioritized replay on classic control tasks."""
    del argv
    logging.info(f'Runs DQN agent with prioritized replay')
