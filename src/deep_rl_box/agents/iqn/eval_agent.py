...
from deep_rl_box.networks.value import IqnMlpNet, IqnConvNet
...
flags.DEFINE_string('load_checkpoint_file', './checkpoints/IQN', 'Load a specific checkpoint file.')
flags.DEFINE_string(
    'recording_video_dir',
    'recordings',
...
def main(argv):
    ...
    checkpoint = TensorFlowCheckpoint(environment_name=FLAGS.environment_name, agent_name='IQN', restore_only=True)
